  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.card_container}>
        ...
        <Location icon="tag" image="rating-1.png" title="Harborside" align="right" content="No fees, 1 hour delivery" rating={4.9} />
        <Location icon="marijuana" image="rating-1.png" title="Harborside" content="No fees, 1 hour delivery" rating={4.9} />
        <Location icon="star" image="rating-1.png" title="Harborside" align="right" content="No fees, 1 hour delivery" rating={4.9} />
